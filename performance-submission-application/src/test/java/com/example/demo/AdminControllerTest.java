...
public class AdminControllerTest {
    ...
    @Test
    public void getspecificEmployee_success() throws Exception {
        Mockito.when(databaseRepository.findById(EMPLOYEE_DATA_1.getEmployeeID()))
                .thenReturn(java.util.Optional.of(EMPLOYEE_DATA_1));
